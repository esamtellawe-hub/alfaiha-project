...
import {
  ...
  MapPin, ArrowRight, Send, CheckCircle2,
} from "lucide-react";
...
const Footer = () => {
  ...
  // footerSections is an object like: { footer_desc: { section_key, content_en, content_ar, content_fr }, ... }
  const getText = (key, lang = "en") => {
    const section = footerSections[key];
    if (!section) return "";
    return section[`content_${lang}`] || section.content_en || "";
  };
    ...
    <footer className="bg-[#0a0a0a] text-white pt-12 pb-6 border-t border-gray-900 font-sans">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          {/* Column 2: Media & Careers — from footer_links table */}
          <div>
          ...
          {/* Column 3: Our Offices — from regional_offices table */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-[#ee2039] pl-3">
          ...
          {/* Column 4: Quick Inquiry + Newsletter */}
            ...
            <div className="mt-8 pt-6 border-t border-gray-700">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                <input
                  ...
                  placeholder={getText("footer_email_placeholder") || "Email Address"}
                ...
                <button
                  ...
                  className="text-[#ee2039] hover:text-white transition-colors disabled:text-gray-500"
                >
        ...
        <div className="border-t border-gray-900 pt-4 mt-6 text-center text-xs text-gray-600">
          <p>
            ...
            {getText("footer_copyright") || "Al Faiha Group. All rights reserved. Powered by"}{" "}
            <a
              href="https://qtechnetworks.com/jo/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#ee2039] font-bold hover:text-white transition-colors"
            >
              QTech
            </a>
          </p>
...
const FooterLink = ({ href, children }) => (
  <li>
    <a
      href={href}
      className="block transition-all duration-300 hover:translate-x-2 hover:text-[#ee2039]"
    >
      {children}
    </a>
  </li>
